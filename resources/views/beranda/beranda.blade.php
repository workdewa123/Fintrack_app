...
<style>
    ...
    .card-text {
        /* Responsif: mengecil otomatis di layar kecil */
...
<div class="container-fluid py-4 px-md-4">
    <div class="row g-4 mb-4">
        <div class="col-md-4">
            <div class="card total-rekening p-4 h-100 border-0 shadow-sm">
                ...
                <h2 class="card-text text-white" id="totalSaldoBeranda">
        ...
        <div class="col-md-4">
            <div class="card total-pemasukan p-4 h-100 border-0 shadow-sm">
                <div class="card-body p-0">
                    ...
                    <h2 class="card-text text-success" id="totalPemasukanBeranda">
        ...
        <div class="col-md-4">
            <div class="card total-pengeluaran p-4 h-100 border-0 shadow-sm">
                <div class="card-body p-0">
                    ...
                    <h2 class="card-text text-danger" id="totalPengeluaranBeranda">
    ...
    <div class="row g-4">
        <div class="col-lg-8">
            <div class="card p-4 h-100 rounded-4 border-0 shadow-sm">
            ...
            <div class="card p-4 h-100 rounded-4 border-0 shadow-sm">
                ...
                <div class="mt-4">
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <span id="labelPemasukan" class="fw-bold">0%</span>
                    </div>
                    <div class="d-flex justify-content-between">
                        <span><i class="bi bi-circle-fill text-danger me-2"></i>Keluar</span>
                        <span id="labelPengeluaran" class="fw-bold">0%</span>
                    </div>
                </div>
            </div>
        </div>
